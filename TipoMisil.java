 ...
 *
 * un misil hipersonico con danio alto sobre
 * un hospital tiene una prioridad mucho mayor que un misil convencional sobre zona industrial
 */
public enum TipoMisil {

    CONVENCIONAL (1.0, 1.0, "Misil convencional"),
    HIPERSONICO (2.0, 1.5, "Misil hipersonico (doble velocidad, daño 1.5x)"),
